...
const articles: Article[] = [
  ...
  },
  {
    ...
    date: "2026.09.14",
    readTime: "6 分鐘",
    excerpt: "歐洲研究年輪的人，找的不是平均寬度，而是最窄的那幾圈。這條線索對上企業變革的三件事：真相藏在最窄的那一段、變革不會補所以要留紀錄、不要用一棵樹代表整片森林。",
    tags: ["組織變革", "成效評估", "決策品質", "管理觀察"],
  },
  {
    slug: "efficiency-concealment-ai-productivity",
    cat: "人才策略",
    title: "效率隱藏：AI 省下的時間，為什麼沒有回到員工身上",
    date: "2026.09.14",
    readTime: "8 分鐘",
    excerpt: "AI 確實省下了時間，但時間去了哪裡？本文切開影子 AI、工作量蔓延與最被低估的效率隱藏，用五份跨國數據與三個案例說明：當誠實有價格，員工就會讓完成看起來像還沒做完。",
    tags: ["效率隱藏", "AI 生產力", "工作設計", "人才策略"],
  },
  {
    slug: "training-replication-gap",
    cat: "人才策略",
    title: "為什麼你的培訓成效複製不了？56 項隨機對照研究給企業的三個提醒",
    date: "2026.09.14",
    readTime: "6 分鐘",
    excerpt: "56 項美國隨機對照研究顯示，培訓讓就業率只升 2 到 3 個百分點、年收入多約 1,000 美元，人均成本卻要 13,000 美元。少數成效高出數倍的計畫又複製不了。三個提醒，談企業該怎麼綁職缺、做驗證。",
    tags: ["企業培訓", "人才策略", "成效驗證", "AI 轉型"],
  },
  {
    slug: "management-gap-2-ai-era",
    cat: "管理心理學",
    title: "管不好人，就管不好 AI：當管理層的大腦還留在十九世紀",
    date: "2026.09.14",
    readTime: "6 分鐘",
    excerpt: "戴明說 94% 的問題來自系統設計，只有 6% 能歸因個人。當組織還在找戰犯，它就失去了唯一能改的選項；更現實的是，不懂認知邊界與流程防呆的組織，也無法為 AI 設計護欄。",
    tags: ["管理心理學", "究責文化", "系統思維", "AI 治理"],
  },
  {
  ...
  },
  {
    ...
    date: "2026.08.28",
    readTime: "8 分鐘",
    excerpt: "7 月被 OpenAI 的智能體入侵生產環境，8 月傳出以 129 億美元被 NVIDIA 收購。全球最大開源 AI 平台的定位與處境，以及 AI 供應鏈整併的幾個訊號。",
    tags: ["Hugging Face", "NVIDIA", "開源 AI", "AI 供應鏈", "智能體安全"],
  },
  {
  ...
  },
  {
    ...
    date: "2026-08-16",
    readTime: "8 分鐘",
    excerpt: "麥肯錫高層罕見公開呼籲年輕顧問「少做像樣內容」，微軟同月砍掉多個 AI 功能——供應端開始收縮，往往是內容泡沫見頂的訊號。AI 是印鈔機、像樣內容是超發貨幣，只有信任無法量產。本文提出信任三道防線，守住唯一不貶值的資產。",
    tags: ["內容策略", "信任", "AI 轉型", "生成式 AI", "數位行銷", "中小企業"],
  },
  {
    slug: "ai-talent-magnet",
    cat: "人才策略",
    title: "搶不到 AI 人才？別再參加薪水拍賣，學會當「人才磁場」",
    date: "2026-08-16",
    readTime: "8 分鐘",
    excerpt: "Meta 開數百萬年薪、馬斯克組精英部隊、亞馬遜再招數千人——AI 人才戰爭打成薪水拍賣。HBR 分析百萬次互動數據卻發現：AI 人才追的不是高薪，是「正在發生的事」。本文提出人才磁場框架：動量、互補能力、可信後的彈性三塊磁鐵，中小企業照樣搶得到人。",
    tags: ["人才策略", "AI 人才", "招募", "雇主品牌", "中小企業", "HR"],
  },
  {
  ...
  },
  {
    ...
    date: "2026-08-04",
    readTime: "9 分鐘",
    excerpt: "《納瓦爾寶典》說財富＝特定知識 × 槓桿，而程式碼與媒體是不需要任何人許可的新槓桿。過去老闆壟斷勞動槓桿，AI 時代這個壟斷被打破了——純監督型管理者的價值正在蒸發。本文從資源基礎理論與自我決定理論雙重視角，拆解管理者如何從「監督勞動槓桿」轉向「設計槓桿組合」，守住唯一不可外包的能力：判斷力。",
    tags: ["納瓦爾寶典", "槓桿", "特定知識", "判斷力", "AI 轉型", "管理心理學"],
  },
  {
    slug: "naval-desire-contract-performance",
    cat: "管理心理學",
    title: "納瓦爾說「欲望是與現狀的契約」：給管理者的 5 個績效設計，別讓員工簽下受苦契約",
    date: "2026-08-04",
    readTime: "6 分鐘",
    excerpt: "納瓦爾寶典的經典金句：「欲望是你與自己簽下的契約，在得到想要的東西之前，你要一直不快樂。」放到職場裡，KPI 與 OKR 就是管理者幫員工簽下的契約——問題不是簽不簽，而是履不履約得起。本文從目標設定理論、享樂適應與心理安全感研究出發，給出 5 個可執行的績效設計原則，讓團隊在追目標的過程中保有心理健康。",
    tags: ["納瓦爾寶典", "績效管理", "目標設定理論", "心理安全感", "倦怠", "管理心理學"],
  },
  {
