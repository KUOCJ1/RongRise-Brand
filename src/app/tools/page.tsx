...
const tools: Tool[] = [
  {
    ...
    icon: "🧑🏼‍💼",
    name: "HR AI 成熟度評估",
    desc: "CJ 哥 20 年人資 × AI 轉型。五大 HR 場景 × 20+ 題，五分鐘找出你的 HR AI 化缺口與優先行動。",
    tag: "自評",
  ...
  },
  {
    ...
    icon: "🧑‍🏫",
    name: "員工 AI 技能路徑圖",
    desc: "選你的部門和 AI 熟度，立即獲得專屬的 90 天養成計畫。五大角色、三級熟度，具體到每週做什麼、用什麼工具。",
    tag: "路徑",
    tagClass: "bg-primary/10 text-primary",
  },
  {
    href: "/ai-governance-scan",
    icon: "🛡️",
    name: "AI 治理五檢查自評",
    desc: "人、流程、資料、技術、文化五大維度 × 20 題，五分鐘測出你的 AI 治理體質與風險警示。",
    tag: "自評",
    tagClass: "bg-teal/10 text-teal",
  },
  {
