            ...
            <div className="mt-12 lg:absolute lg:right-8 lg:top-1/2 lg:-translate-y-1/2 lg:mt-0">
              <div className="flex items-center gap-4 sm:gap-6 lg:flex-col lg:gap-4 lg:w-72">
                <div className="flex items-center gap-4 sm:gap-6">
                  <HeroStat number="20+" label="年跨國人資" dark />
                  <div className="w-px h-8 bg-white/20 lg:w-full lg:h-px" />
                  <HeroStat number="8" label="座獎" dark />
                  <div className="w-px h-8 bg-white/20 lg:w-full lg:h-px" />
                  <HeroStat number="100+" label="家服務客戶" dark />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 relative overflow-hidden bg-cta">
        ...
        <div className="max-w-[800px] mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          <div className="grid grid-cols-2 gap-3 max-w-[520px] mx-auto sm:max-w-none sm:flex sm:flex-wrap sm:justify-center sm:gap-4">
            ...
            <TrackLink href="https://line.me/R/ti/p/@954qxhhe" target="_blank" rel="noopener noreferrer" className="btn-line" trackLabel="加 LINE 聊聊" trackLocation="cta_section">
              加 LINE 聊聊
            </TrackLink>
          </div>
        </div>
